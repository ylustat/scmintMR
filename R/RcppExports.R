...
mintMR <- function(gammah, Gammah, se1, se2, group = NULL, opts = NULL, corr_mat = NULL, reference = NULL, Lambda = NULL, CC = 2L, PC1 = 1L, PC2 = 1L, latent_dim = 2L, display_progress = TRUE, missing_method = "missForest", mvl_method = "DVCCA", epochs = 5L, fast_impute = FALSE, deep = TRUE) {
    .Call(`_scmintMR_mintMR`, gammah, Gammah, se1, se2, group, opts, corr_mat, reference, Lambda, CC, PC1, PC2, latent_dim, display_progress, missing_method, mvl_method, epochs, fast_impute, deep)
}
